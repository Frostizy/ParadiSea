...
<div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
        <!-- Bouton AR -->
        <a href="#"
           class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded block text-center">AR</a>
        <!-- Bouton 1.9 TDi -->
        <a href="#" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded block text-center">1.9 TDi</a>
        <!-- Bouton La Boulonnerie -->
        <a href="#"
           class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded block text-center">La Boulonnerie</a>
    </div>
</div>
</body>
</html>