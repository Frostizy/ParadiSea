...
<div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
        <!-- Bouton Frostizy -->
        <a href="https://www.youtube.com/@frostizy6115"
           class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded block text-center">Frostizy</a>
        <!-- Bouton RPZ -->
        <a href="https://www.youtube.com/@reyz9729"
           class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded block text-center">RaPtorZ</a>
        <!-- Bouton CaPtainChockAPic -->
        <a href="#" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded block text-center">CaPtainChockAPic</a>
    </div>
</div>
</body>
